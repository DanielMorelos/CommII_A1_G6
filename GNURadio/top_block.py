...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Sps = Sps = 8
        self.Rs = Rs = 32000
        self.samp_rate = samp_rate = Rs*Sps*4
        self.h = h = [1]*Sps
        self.Rb = Rb = Rs*bps
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 3e5, 0.5, 0, 1.570796)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 3e5, 0.5, 0, 0)
    ...
    def set_Sps(self, Sps):
        ...
        self.set_samp_rate(self.Rs*self.Sps*4)
