...
class new_hier(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, M=4):
        ...
        self.Constelacion = Constelacion = [1+1j,0+1j,-1+0j,0-1j]
        ...
        self.connect((self.analog_noise_source_x_0, 0), (self.qtgui_time_sink_x_2_1, 0))
    ...
    def set_Rs(self, Rs):
        self.Rs = Rs
        self.set_samp_rate(self.Rs*self.Sps)
        self.qtgui_time_sink_x_2_1.set_samp_rate(self.Rs)
